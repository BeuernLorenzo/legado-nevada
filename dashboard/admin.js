...
// =====================================================
// NEVADA CLOUD — SUPABASE
// Sincronização entre dispositivos
// =====================================================


function cloudRowToPunch(row) {

    const punchedDate =
        new Date(row.punched_at);
    ...
    return {
        ...
        date:
            punchedDate.toLocaleDateString(
                "pt-BR"
            ),

        time:
            punchedDate.toLocaleTimeString(
                "pt-BR",
                {
                    hour: "2-digit",
                    minute: "2-digit",
...
// =====================================================
// MESCLAR REGISTRO SEM DUPLICAR
// =====================================================

function mergeCloudPunch(punch) {
...
async function loadNevadaCloudPunches() {
    ...
    console.log(
        "Nevada Cloud — carregando registros..."
    );
    ...
    /*
        Atualiza sempre, inclusive quando
        não houver um registro novo.
    */
    ...
    console.log(
        `Nevada Cloud — ${data.length} registro(s) carregado(s).`
    );
...
function startNevadaRealtime() {
    ...
    if (
        ...
        console.warn(
            "Nevada Cloud — Realtime indisponível."
        );
    ...
    console.log(
        "Nevada Cloud — conectando Realtime..."
    );
    ...
    nevadaSupabase
        ...
        .on(
            ...
            payload => {
                ...
                console.log(
                    "Nevada Cloud — nova batida recebida:",
                    payload.new
                );
                ...
                /*
                    Só redesenha se for realmente
                    um registro novo.

                    Isso impede duplicata entre:
                    BroadcastChannel +
                    localStorage +
                    Supabase.
                */
